...
INSERT INTO products (id, brand, name, category, icon, gradient_from, gradient_to, price, mrp, max_tenure, rating, reviews, variants, highlights, sort_order) VALUES

('iphone15','Apple','iPhone 15','Mobiles','phone','#6C3CE0','#9169EE',
 79900, 79900, 24, 4.7, '12.4k',
 '[
   {"type":"Storage","options":[{"label":"128GB","delta":0},{"label":"256GB","delta":8000},{"label":"512GB","delta":20000}]},
   {"type":"Color","options":[{"label":"Black","hex":"#1c1c1e","delta":0},{"label":"Blue","hex":"#5773a0","delta":0},{"label":"Pink","hex":"#f3c6cf","delta":0},{"label":"Green","hex":"#a9c0a4","delta":0}]}
 ]'::jsonb,
...
('s24ultra','Samsung','Galaxy S24 Ultra','Mobiles','phone','#2E4CB0','#5C74D6',
...
('mba-m2','Apple','MacBook Air M2','Laptops','laptop','#3E4C6D','#6B7C9E',
...
('bravia55','Sony','Bravia 55" 4K Google TV','TV & Audio','tv','#0F8B8D','#22B6B0',
...
('boat-rockerz','boAt','Rockerz 550 Headphones','TV & Audio','headphones','#D8547A','#F0839B',
 1799, 3499, 6, 4.3, '45k',
 '[
...
('lg-washer','LG','7kg Front Load Washer','Appliances','washer','#C97A1E','#E8A93F',
...
('watch-s9','Apple','Watch Series 9','Wearables','watch','#B01860','#DE4A8D',
...
('dyson-purifier','Dyson','Pure Cool Air Purifier','Appliances','wind','#0D74B8','#3FA8E8',
